...
You must be able to explain FA4 at feeds-and-speeds granularity (implementation is the §7 stretch). **Honesty flags up front:** FA4 is **partly public** — Tri Dao's blog (tridao.me/blog/2026/flash4) and the PyTorch FlexAttention+FA4 blog (2026-03-05), with code in **CuTe-DSL**. The **BF16 forward** numbers below are public. The **low-precision (FP8/FP4) FA4** accuracy/throughput numbers are **not yet public** — do **not** invent them; flag the gap. The exact rescale threshold τ and the precise MUFU/FMA split for emulated exp are also **not public**.
...
**FA4 numbers (public, BF16):** B200 BF16 up to **1605 TFLOP/s = 71% utilization**; up to **1.3× cuDNN 9.13**; **2.7× Triton**; entirely in **CuTe-DSL**. (FP8/FP4 FA4: not yet public — flag it.)
...
- Dao. **FlashAttention-4** — blog: tridao.me/blog/2026/flash4; PyTorch **FlexAttention + FA4** blog (2026-03-05). *(Asymmetric scaling; tcgen05/TMEM; conditional rescale; emulated exp2; CuTe-DSL; BF16 1605 TFLOP/s = 71%. FP8/FP4 numbers not yet public.)*
