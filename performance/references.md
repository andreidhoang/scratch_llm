...
- **The "CUDA for Deep Learning" book** (Manning MEAP v5, E. Arledge) — the chapters 5–10 this curriculum is built from. *Audited 2026-07-15 against the ledger (and the since-deleted `KERNEL_ROADMAP_2026`); V05 PDF = 455 pp, ch1–10 + App A (`JOB_SPRINT/CUDA_for_Deep_Learning_v5_MEAP.pdf`).* Lineage is 1:1 and already in each A-file header (A1←5 · A2←6 · A3←7 · A4←8 · A5←9 · A6←10). **Use it as follows:**
