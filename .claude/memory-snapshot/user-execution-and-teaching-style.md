...
permission per step, commit with the green gate, push to origin main when asked (gh CLI is
authenticated on the box; repo-local credential.helper is set to `!gh auth git-credential`).
