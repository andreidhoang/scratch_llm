...
## Auto-Approved Commands (No Confirmation Required)

These commands can be executed without asking for user permission:
- `pytest tests/...` - Running Python tests
- `PYTHONPATH=. ruff check orchestrator api_gateway --ignore E501,F401,E402` - Lint checks
- `PYTHONPATH=. pytest ...` - Running tests with PYTHONPATH set
