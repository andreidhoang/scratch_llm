Learning-node: M3 Bài 3.3 — cosine schedule + warmup + gradient clipping (`optim.py` cosine_lr/grad clip). ✅ M3 3.2 AdamW (2026-07-14). 📚 **DERIVATION DOCS 16/16 PILLAR COMPLETE (2026-07-14)** — `docs/learning/derivations/` (9,782 dòng, mọi neo code verified + math re-derived + số đo chạy lại được; 12 FIXED/3 SOUND, 0 rewrite). *Viết-doc = substrate re-learn, KHÁC teach-back:* cột dưới vẫn track **cold defense** của Navigator (mastery thật). Teach-back đã defend cold: M1 1.1–1.4 · M2 2.1–2.3 (2.4–2.6 Driver-explained) · M3 3.1–3.2. Node teach-back kế = 3.3. Nợ re-own: 2.4/2.5/2.6/3.1/3.2 + mờ 2.3 (i)/(ii). Mở 3.3: spaced recall (1 step AdamW?) → cold predictions cho warmup + cosine + grad clip.
