...
node: **A1 R4.6 PD-disaggregation** (R4.5 MLA ✅ 2026-07-04: weight-absorption identity to machine
eps, KV 3.56× < GQA-8) (`performance/PERF_PLAN.md`). **CS336-A2 distributed half ✅ SHIPPED 2026-07-03** (ZeRO-1 ·
