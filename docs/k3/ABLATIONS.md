...
iso-FLOP discipline + seeds + the F12-winning corpus (one harness); `docs/RESULTS.md` (one
...
F4 bf16/compile · F7 GRPO "aha" · F8 DSA · F11 agentic RL · F12 corpus.
...
## R0 — Anatomy of Kimi K3 (zero-cost, CPU, STARTED 2026-07-31)
...
**First observations (measured by us, 2026-07-31, smoke = layers 0–1; full census in flight):**
...
**R0 now** (script shipped + verified live 2026-07-31; full census in flight) → `core/kda.py`
hand-built + PROVEN → K6 wiring (mini-K3 on the speedrun spine) → **R1 → R2** → Tier 2.
d-series (F12/S3/d20) stays on schedule as the control family — do not bend it.
