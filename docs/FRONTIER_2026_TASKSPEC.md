...
2. **The $100 d20 (8×H100, measured 480.4M @ vocab 32768) beats a PRE-REGISTERED report-card bar**
   (> nano **and** the pre-registered CORE band **0.19–0.22** — re-anchored 2026-08-02 to **0.23–0.25**
   vs the current ClimbMix curve, `docs/RESULTS.md` §S4-pre — vs the original-nanochat-d20 anchor
